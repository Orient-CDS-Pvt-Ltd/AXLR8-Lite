...
2. **Register (once).** On first open you'll be asked for a few details and sent
   to a short registration form. Submit it and the chat is ready — it's free, with
   no license key and no activation step.
